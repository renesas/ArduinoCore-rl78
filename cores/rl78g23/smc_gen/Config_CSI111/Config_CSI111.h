...
#ifndef CFG_Config_CSI111_H
#define CFG_Config_CSI111_H
...
Macro definitions
***********************************************************************************************************************/
#define __SAU0_CH3_BAUDRATE_DIVISOR    (0xU)    /* transfer clock set by dividing the operating clock */
